...
/**
 * Created by chenjunjun on 16/1/14 11:22
 */
public class Test1 {
    /**
     * 文件处理示例
    ...
    public static void createFile() {
        File f=new File("/Users/OnlyAnywhere/TEST/create.txt");
        try{
            f.createNewFile();  //当且仅当不存在具有此抽象路径名指定名称的文件时，不可分地创建一个新的空文件。
            System.out.println("该分区大小"+f.getTotalSpace()/(1000*1000*1000)+"G"); //返回由此抽象路径名表示的文件或目录的名称。
